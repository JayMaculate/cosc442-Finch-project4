 ...
 *
 * @generatedBy CodePro at 3/20/18 6:57 PM
 * @author joshuafinch
...
public class CoffeeMakerTest {
	...
	/**
	 * Run the boolean recipeExist(Recipe,boolean) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/20/18 6:57 PM
	 */
	@Test
	public void testRecipeExist_1()
		throws Exception {
		CoffeeMaker fixture = new CoffeeMaker();
		Recipe r = new Recipe();
		boolean canAddRecipe = true;

		boolean result = fixture.recipeExist(r, canAddRecipe);
