...
public class Main {
    ...
    public static void mainMenu() {
        ...
        System.out.println("0. Exit"+seperator);
	...
	public static void addRecipe() {
	    //Read in recipe name
	    final String name = inputOutput(seperator+"Please enter the recipe name: ");
	    
	    //Read in recipe price
	    final String priceString = inputOutput(seperator+"Please enter the recipe price: $");
	    ...
	    //Read in amt coffee
	    final String coffeeString = inputOutput(seperator+"Please enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(seperator+"Please enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput(seperator+"Please enter the units of sugar in the recipe: ");
	    ...
	    final String chocolateString = inputOutput(seperator+"Please enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
    	final String coffeeString = inputOutput(seperator+"Please enter the units of coffee to add: ");
    	final int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    String milkString = inputOutput(seperator+"Please enter the units of milk to add: ");
	    ...
	    //Read in amt sugar
	    String sugarString = inputOutput(seperator+"Please enter the units of sugar to add: ");
	    ...
	    //Read in amt chocolate
	    String chocolateString = inputOutput(seperator+"Please enter the units of chocolate to add: ");
    ...
    public static void makeCoffee() {
        ...
        System.out.println("Your change is: " + change + seperator);
        mainMenu();
    }
    ...
    private static int stringToInt(String value) {
        ...
        try {
            ...
            System.out.println("Please input an integer"+seperator);
        }
        return returnInt;
    }
    
    static String seperator = System.getProperty("line.seperator");
    /**
     * Method main.
     * @param args String[]
     */
    public static void main(String[] args) {
	    ...
	    System.out.println("Welcome to the CoffeeMaker!"+seperator);
	    mainMenu();
	}
}
